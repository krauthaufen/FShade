...
//    let inlineEffectData (dirs : list<string>) (fshade : Assembly) (entries : list<string * int * int * byte[]>) =
...
//            let resolveAssembly (par : option<ReaderParameters>) (assName : AssemblyNameReference) =
...
//                                let ass = 
//                                    match par with
//                                    | Some par -> AssemblyDefinition.ReadAssembly(p, par)
//                                    | None -> AssemblyDefinition.ReadAssembly(p)
...
//                        match resolveAssembly None name with
//                        | Some a -> a
//                        | None -> null
//                    member x.Resolve(name, p) =
//                        match resolveAssembly (Some p) name with
//                        | Some a -> a
//                        | None -> null
//                    member x.Dispose() =
//                        ()
