    ...
    let (|IntrinsicFunction|_|) : MethodInfo -> ValueOption<CIntrinsic> =
        MethodTable.ofList [
            ...
            CIntrinsic.simple "pow", [
                ...
                exactly <@ Fun.Pow : V2ui * V2f -> V2f @>
                exactly <@ Fun.Pow : V3ui * V3f -> V3f @>
                exactly <@ Fun.Pow : V4ui * V4f -> V4f @>
            ...
            CIntrinsic.simple "pow", [
                ...
                exactly <@ pown : float32 -> int32 -> float32 @>

                exactly <@ pown : V2f -> V2i -> V2f @>
                exactly <@ pown : V3f -> V3i -> V3f @>
                exactly <@ pown : V4f -> V4i -> V4f @>
            ]

            CIntrinsic.tagged "int8_t(pow({0}, {1}))", [
                exactly <@ Fun.Pown : int8 * int8  -> int8 @>
                exactly <@ Fun.Pown : int8 * int32 -> int8 @>
                exactly <@ pown : int8 -> int8  -> int8 @>
                exactly <@ pown : int8 -> int32 -> int8 @>
            ]

            CIntrinsic.tagged "uint8_t(pow({0}, {1}))", [
                exactly <@ Fun.Pown : uint8 * uint8 -> uint8 @>
                exactly <@ Fun.Pown : uint8 * int32 -> uint8 @>
                exactly <@ pown : uint8 -> uint8 -> uint8 @>
                exactly <@ pown : uint8 -> int32 -> uint8 @>
            ]

            CIntrinsic.tagged "int16_t(pow({0}, {1}))", [
                exactly <@ Fun.Pown : int16 * int16 -> int16 @>
                exactly <@ Fun.Pown : int16 * int32 -> int16 @>
                exactly <@ pown : int16 -> int16 -> int16 @>
                exactly <@ pown : int16 -> int32 -> int16 @>
            ]

            CIntrinsic.tagged "uint16_t(pow({0}, {1}))", [
                exactly <@ Fun.Pown : uint16 * uint16 -> uint16 @>
                exactly <@ Fun.Pown : uint16 * int32  -> uint16 @>
                exactly <@ pown : uint16 -> uint16 -> uint16 @>
                exactly <@ pown : uint16 -> int32  -> uint16 @>
            ]

            CIntrinsic.tagged "int(pow({0}, {1}))", [
                exactly <@ Fun.Pown : int32 * int32 -> int32 @>
                exactly <@ pown : int32 -> int32 -> int32 @>
            ]

            CIntrinsic.tagged "uint(pow({0}, {1}))", [
                exactly <@ Fun.Pown : uint32 * uint32 -> uint32 @>
                exactly <@ Fun.Pown : uint32 * int32  -> uint32 @>
                exactly <@ pown : uint32 -> uint32 -> uint32 @>
                exactly <@ pown : uint32 -> int32  -> uint32 @>
            ]

            CIntrinsic.tagged "ivec2(pow({0}, {1}))", [
                exactly <@ Fun.Pown : V2i * V2i -> V2i @>
                exactly <@ pown : V2i -> V2i -> V2i @>
            ]

            CIntrinsic.tagged "ivec3(pow({0}, {1}))", [
                exactly <@ Fun.Pown : V3i * V3i -> V3i @>
                exactly <@ pown : V3i -> V3i -> V3i @>
            ]

            CIntrinsic.tagged "ivec4(pow({0}, {1}))", [
                exactly <@ Fun.Pown : V4i * V4i -> V4i @>
                exactly <@ pown : V4i -> V4i -> V4i @>
            ]

            CIntrinsic.tagged "uvec2(pow({0}, {1}))", [
                exactly <@ Fun.Pown : V2ui * V2ui -> V2ui @>
                exactly <@ Fun.Pown : V2ui * V2i  -> V2ui @>
                exactly <@ pown : V2ui -> V2ui -> V2ui @>
                exactly <@ pown : V2ui -> V2i  -> V2ui @>
            ]

            CIntrinsic.tagged "uvec3(pow({0}, {1}))", [
                exactly <@ Fun.Pown : V3ui * V3ui -> V3ui @>
                exactly <@ Fun.Pown : V3ui * V3i  -> V3ui @>
                exactly <@ pown : V3ui -> V3ui -> V3ui @>
                exactly <@ pown : V3ui -> V3i  -> V3ui @>
            ]

            CIntrinsic.tagged "uvec4(pow({0}, {1}))", [
                exactly <@ Fun.Pown : V4ui * V4ui -> V4ui @>
                exactly <@ Fun.Pown : V4ui * V4i  -> V4ui @>
                exactly <@ pown : V4ui -> V4ui -> V4ui @>
                exactly <@ pown : V4ui -> V4i  -> V4ui @>
            ]

            CIntrinsic.tagged "pow({0}, vec2({1}))", [
                exactly <@ Fun.Pow : V2f  * float32 -> V2f @>
                exactly <@ Fun.Pow : V2i  * float32 -> V2f @>
                exactly <@ Fun.Pow : V2ui * float32 -> V2f @>
            ...
            CIntrinsic.tagged "ivec2(pow({0}, vec2({1})))", [
                exactly <@ Fun.Pown : V2i *  int32 -> V2i @>
                exactly <@ pown     : V2i -> int32 -> V2i @>
            ]

            CIntrinsic.tagged "uvec2(pow({0}, vec2({1})))", [
                exactly <@ Fun.Pown : V2ui *  int32  -> V2ui @>
                exactly <@ Fun.Pown : V2ui *  uint32 -> V2ui @>
                exactly <@ pown     : V2ui -> uint32 -> V2ui @>
                exactly <@ pown     : V2ui -> int32  -> V2ui @>
            ]

            CIntrinsic.tagged "pow({0}, vec3({1}))", [
                exactly <@ Fun.Pow : V3f  * float32 -> V3f @>
                exactly <@ Fun.Pow : V3i  * float32 -> V3f @>
                exactly <@ Fun.Pow : V3ui * float32 -> V3f @>

                exactly <@ Fun.Pown : V3f * int32 -> V3f @>

                exactly <@ pow    : V3f -> float32 -> V3f @>
                exactly <@ ( ** ) : V3f -> float32 -> V3f @>

                exactly <@ pown : V3f  -> int32  -> V3f @>
            ]

            CIntrinsic.tagged "ivec3(pow({0}, vec3({1})))", [
                exactly <@ Fun.Pown : V3i *  int32 -> V3i @>
                exactly <@ pown     : V3i -> int32 -> V3i @>
            ]

            CIntrinsic.tagged "uvec3(pow({0}, vec3({1})))", [
                exactly <@ Fun.Pown : V3ui *  int32  -> V3ui @>
                exactly <@ Fun.Pown : V3ui *  uint32 -> V3ui @>
                exactly <@ pown     : V3ui -> uint32 -> V3ui @>
                exactly <@ pown     : V3ui -> int32  -> V3ui @>
            ]

            CIntrinsic.tagged "pow({0}, vec4({1}))", [
                exactly <@ Fun.Pow : V4f  * float32 -> V4f @>
                exactly <@ Fun.Pow : V4i  * float32 -> V4f @>
                exactly <@ Fun.Pow : V4ui * float32 -> V4f @>

                exactly <@ Fun.Pown : V4f * int32 -> V4f @>

                exactly <@ pow    : V4f -> float32 -> V4f @>
                exactly <@ ( ** ) : V4f -> float32 -> V4f @>

                exactly <@ pown : V4f  -> int32  -> V4f @>
            ]

            CIntrinsic.tagged "ivec4(pow({0}, vec4({1})))", [
                exactly <@ Fun.Pown : V4i *  int32 -> V4i @>
                exactly <@ pown     : V4i -> int32 -> V4i @>
            ]

            CIntrinsic.tagged "uvec4(pow({0}, vec4({1})))", [
                exactly <@ Fun.Pown : V4ui *  int32  -> V4ui @>
                exactly <@ Fun.Pown : V4ui *  uint32 -> V4ui @>
                exactly <@ pown     : V4ui -> uint32 -> V4ui @>
                exactly <@ pown     : V4ui -> int32  -> V4ui @>
            ]

            CIntrinsic.tagged "pow(vec2({0}), {1})", [
                exactly <@ Fun.Pow : float32 * V2f -> V2f @>
                exactly <@ Fun.Pow : int32   * V2f -> V2f @>
                exactly <@ Fun.Pow : uint32  * V2f -> V2f @>

                exactly <@ Fun.Pown : float32 * V2i -> V2f @>
            ]

            CIntrinsic.tagged "ivec2(pow(vec2({0}), {1}))", [
                exactly <@ Fun.Pown : int32 * V2i  -> V2i @>
            ]

            CIntrinsic.tagged "uvec2(pow(vec2({0}), {1}))", [
                exactly <@ Fun.Pown : uint32 * V2i  -> V2ui @>
                exactly <@ Fun.Pown : uint32 * V2ui -> V2ui @>
            ]

            CIntrinsic.tagged "pow(vec3({0}), {1})", [
                exactly <@ Fun.Pow : float32 * V3f -> V3f @>
                exactly <@ Fun.Pow : int32   * V3f -> V3f @>
                exactly <@ Fun.Pow : uint32  * V3f -> V3f @>

                exactly <@ Fun.Pown : float32 * V3i -> V3f @>
            ]

            CIntrinsic.tagged "ivec3(pow(vec3({0}), {1}))", [
                exactly <@ Fun.Pown : int32 * V3i  -> V3i @>
            ]

            CIntrinsic.tagged "uvec3(pow(vec3({0}), {1}))", [
                exactly <@ Fun.Pown : uint32 * V3i  -> V3ui @>
                exactly <@ Fun.Pown : uint32 * V3ui -> V3ui @>
            ]

            CIntrinsic.tagged "pow(vec4({0}), {1})", [
                exactly <@ Fun.Pow : float32 * V4f -> V4f @>
                exactly <@ Fun.Pow : int32   * V4f -> V4f @>
                exactly <@ Fun.Pow : uint32  * V4f -> V4f @>

                exactly <@ Fun.Pown : float32 * V4i -> V4f @>
            ]

            CIntrinsic.tagged "ivec4(pow(vec4({0}), {1}))", [
                exactly <@ Fun.Pown : int32 * V4i  -> V4i @>
            ]

            CIntrinsic.tagged "uvec4(pow(vec4({0}), {1}))", [
                exactly <@ Fun.Pown : uint32 * V4i  -> V4ui @>
                exactly <@ Fun.Pown : uint32 * V4ui -> V4ui @>
            ]
            ...
            CIntrinsic.tagged "double(exp({0}))", [
            ...
            CIntrinsic.tagged "dvec2(exp({0}))", [
                exactly <@ Fun.Exp : V2i  -> V2d @>
                exactly <@ Fun.Exp : V2ui -> V2d @>
            ]

            CIntrinsic.tagged "dvec3(exp({0}))", [
                exactly <@ Fun.Exp : V3i  -> V3d @>
                exactly <@ Fun.Exp : V3ui -> V3d @>
            ]

            CIntrinsic.tagged "dvec4(exp({0}))", [
                exactly <@ Fun.Exp : V4i  -> V4d @>
                exactly <@ Fun.Exp : V4ui -> V4d @>
            ]
            ...
            CIntrinsic.tagged "double(log({0}))", [
            ...
            CIntrinsic.tagged "dvec2(log({0}))", [
                exactly <@ Fun.Log : V2i  -> V2d @>
                exactly <@ Fun.Log : V2ui -> V2d @>
            ]

            CIntrinsic.tagged "dvec3(log({0}))", [
                exactly <@ Fun.Log : V3i  -> V3d @>
                exactly <@ Fun.Log : V3ui -> V3d @>
            ]

            CIntrinsic.tagged "dvec4(log({0}))", [
                exactly <@ Fun.Log : V4i  -> V4d @>
                exactly <@ Fun.Log : V4ui -> V4d @>
            ]
            ...
            CIntrinsic.tagged "double(log2({0}))", [
            ...
            CIntrinsic.tagged "dvec2(log2({0}))", [
                exactly <@ Fun.Log2 : V2i  -> V2d @>
                exactly <@ Fun.Log2 : V2ui -> V2d @>
            ]

            CIntrinsic.tagged "dvec3(log2({0}))", [
                exactly <@ Fun.Log2 : V3i  -> V3d @>
                exactly <@ Fun.Log2 : V3ui -> V3d @>
            ]

            CIntrinsic.tagged "dvec4(log2({0}))", [
                exactly <@ Fun.Log2 : V4i  -> V4d @>
                exactly <@ Fun.Log2 : V4ui -> V4d @>
            ]

            // Note: GLSL sqrt actually supports double types
            ...
            CIntrinsic.tagged "sqrt(double({0}))", [
            ...
            CIntrinsic.tagged "sqrt(dvec2({0}))", [
                exactly <@ Fun.Sqrt : V2i  -> V2d @>
                exactly <@ Fun.Sqrt : V2ui -> V2d @>
                exactly <@ Fun.Sqrt : V2l  -> V2d @>
            ]

            CIntrinsic.tagged "sqrt(dvec3({0}))", [
                exactly <@ Fun.Sqrt : V3i  -> V3d @>
                exactly <@ Fun.Sqrt : V3ui -> V3d @>
                exactly <@ Fun.Sqrt : V3l  -> V3d @>
            ]

            CIntrinsic.tagged "sqrt(dvec4({0}))", [
                exactly <@ Fun.Sqrt : V4i  -> V4d @>
                exactly <@ Fun.Sqrt : V4ui -> V4d @>
                exactly <@ Fun.Sqrt : V4l  -> V4d @>
            ]

            CIntrinsic.tagged "pow({0}, 0.333333333333)", [
                exactly <@ Fun.Cbrt : float32 -> _ @>
                exactly <@ cbrt     : float32 -> _ @>
            ]

            CIntrinsic.tagged "double(pow({0}, 0.333333333333))", [
            ...
            CIntrinsic.tagged "dvec2(pow({0}, vec2(0.333333333333)))", [
                exactly <@ Fun.Cbrt : V2i  -> _ @>
                exactly <@ Fun.Cbrt : V2ui -> _ @>
            ]
            ...
            CIntrinsic.tagged "dvec3(pow({0}, vec3(0.333333333333)))", [
                exactly <@ Fun.Cbrt : V3i  -> _ @>
                exactly <@ Fun.Cbrt : V3ui -> _ @>
            ]
            ...
            CIntrinsic.tagged "dvec4(pow({0}, vec4(0.333333333333)))", [
                exactly <@ Fun.Cbrt : V4i  -> _ @>
                exactly <@ Fun.Cbrt : V4ui -> _ @>
            ]
            ...
            CIntrinsic.tagged "int8_t(sign({0}))", [
                exactly <@ Fun.Signum : int8 -> _ @>
                exactly <@ signum     : int8 -> _ @>
            ]

            CIntrinsic.tagged "int16_t(sign({0}))", [
                exactly <@ Fun.Signum : int16 -> _ @>
                exactly <@ signum     : int16 -> _ @>
            ]

            CIntrinsic.tagged "int64_t(sign({0}))", [
                exactly <@ Fun.Signum : int64 -> _ @>
                exactly <@ signum     : int64 -> _ @>
            ]

            CIntrinsic.tagged "i64vec2(sign({0}))", [
                exactly <@ Fun.Signum : V2l -> _ @>
                exactly <@ signum     : V2l -> _ @>
            ]

            CIntrinsic.tagged "i64vec3(sign({0}))", [
                exactly <@ Fun.Signum : V3l -> _ @>
                exactly <@ signum     : V3l -> _ @>
            ]

            CIntrinsic.tagged "i64vec4(sign({0}))", [
                exactly <@ Fun.Signum : V4l -> _ @>
                exactly <@ signum     : V4l -> _ @>
            ]
            ...
            CIntrinsic.simple "min", [
                ...
                exactly <@ Fun.Min : V2i  * V2i  -> _ @>
                exactly <@ Fun.Min : V3i  * V3i  -> _ @>
                exactly <@ Fun.Min : V4i  * V4i  -> _ @>
                exactly <@ Fun.Min : V2ui * V2ui -> _ @>
                exactly <@ Fun.Min : V3ui * V3ui -> _ @>
                exactly <@ Fun.Min : V4ui * V4ui -> _ @>
                exactly <@ Fun.Min : V2f  * V2f  -> _ @>
                exactly <@ Fun.Min : V3f  * V3f  -> _ @>
                exactly <@ Fun.Min : V4f  * V4f  -> _ @>
                exactly <@ Fun.Min : V2d  * V2d  -> _ @>
                exactly <@ Fun.Min : V3d  * V3d  -> _ @>
                exactly <@ Fun.Min : V4d  * V4d  -> _ @>
                exactly <@ Fun.Min : V2i  * int32   -> _ @>
                exactly <@ Fun.Min : V3i  * int32   -> _ @>
                exactly <@ Fun.Min : V4i  * int32   -> _ @>
                exactly <@ Fun.Min : V2ui * uint32  -> _ @>
                exactly <@ Fun.Min : V3ui * uint32  -> _ @>
                exactly <@ Fun.Min : V4ui * uint32  -> _ @>
                exactly <@ Fun.Min : V2f  * float32 -> _ @>
                exactly <@ Fun.Min : V3f  * float32 -> _ @>
                exactly <@ Fun.Min : V4f  * float32 -> _ @>
                exactly <@ Fun.Min : V2d  * float   -> _ @>
                exactly <@ Fun.Min : V3d  * float   -> _ @>
                exactly <@ Fun.Min : V4d  * float   -> _ @>

                generic <@ Operators.min : int -> int -> int @>
                generic <@ min : int -> int -> int @>
            ]

            CIntrinsic.tagged "int8_t(min({0}, {1}))", [
                exactly <@ Math.Min : int8 * int8 -> _ @>
                exactly <@ Fun.Min  : int8 * int8 -> _ @>
                exactly <@ Fun.Min  : int8 * int8 -> _ @>
                exactly <@ Operators.min : int8 -> int8 -> _ @>
                exactly <@ min : int8 -> int8 -> _ @>
            ]

            CIntrinsic.tagged "uint8_t(min({0}, {1}))", [
                exactly <@ Math.Min : uint8 * uint8 -> _ @>
                exactly <@ Fun.Min  : uint8 * uint8 -> _ @>
                exactly <@ Fun.Min  : uint8 * uint8 -> _ @>
                exactly <@ Operators.min : uint8 -> uint8 -> _ @>
                exactly <@ min : uint8 -> uint8 -> _ @>
            ]

            CIntrinsic.tagged "int16_t(min({0}, {1}))", [
                exactly <@ Math.Min : int16 * int16 -> _ @>
                exactly <@ Fun.Min  : int16 * int16 -> _ @>
                exactly <@ Fun.Min  : int16 * int16 -> _ @>
                exactly <@ Operators.min : int16 -> int16 -> _ @>
                exactly <@ min : int16 -> int16 -> _ @>
            ]

            CIntrinsic.tagged "uint16_t(min({0}, {1}))", [
                exactly <@ Math.Min : uint16 * uint16 -> _ @>
                exactly <@ Fun.Min  : uint16 * uint16 -> _ @>
                exactly <@ Fun.Min  : uint16 * uint16 -> _ @>
                exactly <@ Operators.min : uint16 -> uint16 -> _ @>
                exactly <@ min : uint16 -> uint16 -> _ @>
            ]

            CIntrinsic.tagged "int64_t(min({0}, {1}))", [
                exactly <@ Math.Min : int64 * int64 -> _ @>
                exactly <@ Fun.Min  : int64 * int64 -> _ @>
                exactly <@ Fun.Min  : int64 * int64 -> _ @>
                exactly <@ Operators.min : int64 -> int64 -> _ @>
                exactly <@ min : int64 -> int64 -> _ @>
            ]

            CIntrinsic.tagged "uint64_t(min({0}, {1}))", [
                exactly <@ Math.Min : uint64 * uint64 -> _ @>
                exactly <@ Fun.Min  : uint64 * uint64 -> _ @>
                exactly <@ Fun.Min  : uint64 * uint64 -> _ @>
                exactly <@ Operators.min : uint64 -> uint64 -> _ @>
                exactly <@ min : uint64 -> uint64 -> _ @>
            ]

            CIntrinsic.tagged "i64vec2(min({0}, {1}))", [
                exactly <@ Fun.Min : V2l * V2l   -> _ @>
                exactly <@ Fun.Min : V2l * int64 -> _ @>
                exactly <@ min : V2l -> V2l -> _ @>
            ]

            CIntrinsic.tagged "i64vec3(min({0}, {1}))", [
                exactly <@ Fun.Min : V3l * V3l   -> _ @>
                exactly <@ Fun.Min : V3l * int64 -> _ @>
                exactly <@ min : V3l -> V3l -> _ @>
            ]

            CIntrinsic.tagged "i64vec4(min({0}, {1}))", [
                exactly <@ Fun.Min : V4l * V4l   -> _ @>
                exactly <@ Fun.Min : V4l * int64 -> _ @>
                exactly <@ min : V4l -> V4l -> _ @>
            ]

            CIntrinsic.custom "min" [1; 0], [
                exactly <@ Fun.Min : int32   * V2i  -> _ @>
                exactly <@ Fun.Min : int32   * V3i  -> _ @>
                exactly <@ Fun.Min : int32   * V4i  -> _ @>
                exactly <@ Fun.Min : uint32  * V2ui -> _ @>
                exactly <@ Fun.Min : uint32  * V3ui -> _ @>
                exactly <@ Fun.Min : uint32  * V4ui -> _ @>
                exactly <@ Fun.Min : float32 * V2f  -> _ @>
                exactly <@ Fun.Min : float32 * V3f  -> _ @>
                exactly <@ Fun.Min : float32 * V4f  -> _ @>
                exactly <@ Fun.Min : float   * V2d  -> _ @>
                exactly <@ Fun.Min : float   * V3d  -> _ @>
                exactly <@ Fun.Min : float   * V4d  -> _ @>
                ...
                exactly <@ min : float   -> V2d  -> _ @>
                exactly <@ min : float   -> V3d  -> _ @>
                exactly <@ min : float   -> V4d  -> _ @>
            ]

            CIntrinsic.tagged "i64vec2(min({1}, {0}))", [
                exactly <@ Fun.Min : int64 * V2l -> _ @>
                exactly <@ min : int64 -> V2l -> _ @>
            ]

            CIntrinsic.tagged "i64vec3(min({1}, {0}))", [
                exactly <@ Fun.Min : int64 * V3l -> _ @>
                exactly <@ min : int64 -> V3l -> _ @>
            ]

            CIntrinsic.tagged "i64vec4(min({1}, {0}))", [
                exactly <@ Fun.Min : int64 * V4l -> _ @>
                exactly <@ min : int64 -> V4l -> _ @>
            ]
            ...
            CIntrinsic.simple "max", [
                ...
                exactly <@ Fun.Max : V2i  * V2i  -> _ @>
                exactly <@ Fun.Max : V3i  * V3i  -> _ @>
                exactly <@ Fun.Max : V4i  * V4i  -> _ @>
                exactly <@ Fun.Max : V2ui * V2ui -> _ @>
                exactly <@ Fun.Max : V3ui * V3ui -> _ @>
                exactly <@ Fun.Max : V4ui * V4ui -> _ @>
                exactly <@ Fun.Max : V2f  * V2f  -> _ @>
                exactly <@ Fun.Max : V3f  * V3f  -> _ @>
                exactly <@ Fun.Max : V4f  * V4f  -> _ @>
                exactly <@ Fun.Max : V2d  * V2d  -> _ @>
                exactly <@ Fun.Max : V3d  * V3d  -> _ @>
                exactly <@ Fun.Max : V4d  * V4d  -> _ @>
                exactly <@ Fun.Max : V2i  * int32   -> _ @>
                exactly <@ Fun.Max : V3i  * int32   -> _ @>
                exactly <@ Fun.Max : V4i  * int32   -> _ @>
                exactly <@ Fun.Max : V2ui * uint32  -> _ @>
                exactly <@ Fun.Max : V3ui * uint32  -> _ @>
                exactly <@ Fun.Max : V4ui * uint32  -> _ @>
                exactly <@ Fun.Max : V2f  * float32 -> _ @>
                exactly <@ Fun.Max : V3f  * float32 -> _ @>
                exactly <@ Fun.Max : V4f  * float32 -> _ @>
                exactly <@ Fun.Max : V2d  * float   -> _ @>
                exactly <@ Fun.Max : V3d  * float   -> _ @>
                exactly <@ Fun.Max : V4d  * float   -> _ @>

                generic <@ Operators.max : int -> int -> int @>
                generic <@ max : float -> float -> _ @>
            ]

            CIntrinsic.tagged "int8_t(max({0}, {1}))", [
                exactly <@ Math.Max : int8 * int8 -> _ @>
                exactly <@ Fun.Max  : int8 * int8 -> _ @>
                exactly <@ Fun.Max  : int8 * int8 -> _ @>
                exactly <@ Operators.max : int8 -> int8 -> _ @>
                exactly <@ max : int8 -> int8 -> _ @>
            ]

            CIntrinsic.tagged "uint8_t(max({0}, {1}))", [
                exactly <@ Math.Max : uint8 * uint8 -> _ @>
                exactly <@ Fun.Max  : uint8 * uint8 -> _ @>
                exactly <@ Fun.Max  : uint8 * uint8 -> _ @>
                exactly <@ Operators.max : uint8 -> uint8 -> _ @>
                exactly <@ max : uint8 -> uint8 -> _ @>
            ]

            CIntrinsic.tagged "int16_t(max({0}, {1}))", [
                exactly <@ Math.Max : int16 * int16 -> _ @>
                exactly <@ Fun.Max  : int16 * int16 -> _ @>
                exactly <@ Fun.Max  : int16 * int16 -> _ @>
                exactly <@ Operators.max : int16 -> int16 -> _ @>
                exactly <@ max : int16 -> int16 -> _ @>
            ]

            CIntrinsic.tagged "uint16_t(max({0}, {1}))", [
                exactly <@ Math.Max : uint16 * uint16 -> _ @>
                exactly <@ Fun.Max  : uint16 * uint16 -> _ @>
                exactly <@ Fun.Max  : uint16 * uint16 -> _ @>
                exactly <@ Operators.max : uint16 -> uint16 -> _ @>
                exactly <@ max : uint16 -> uint16 -> _ @>
            ]

            CIntrinsic.tagged "int64_t(max({0}, {1}))", [
                exactly <@ Math.Max : int64 * int64 -> _ @>
                exactly <@ Fun.Max  : int64 * int64 -> _ @>
                exactly <@ Fun.Max  : int64 * int64 -> _ @>
                exactly <@ Operators.max : int64 -> int64 -> _ @>
                exactly <@ max : int64 -> int64 -> _ @>
            ]

            CIntrinsic.tagged "uint64_t(max({0}, {1}))", [
                exactly <@ Math.Max : uint64 * uint64 -> _ @>
                exactly <@ Fun.Max  : uint64 * uint64 -> _ @>
                exactly <@ Fun.Max  : uint64 * uint64 -> _ @>
                exactly <@ Operators.max : uint64 -> uint64 -> _ @>
                exactly <@ max : uint64 -> uint64 -> _ @>
            ]

            CIntrinsic.tagged "i64vec2(max({0}, {1}))", [
                exactly <@ Fun.Max : V2l * V2l   -> _ @>
                exactly <@ Fun.Max : V2l * int64 -> _ @>
                exactly <@ max : V2l -> V2l -> _ @>
            ]

            CIntrinsic.tagged "i64vec3(max({0}, {1}))", [
                exactly <@ Fun.Max : V3l * V3l   -> _ @>
                exactly <@ Fun.Max : V3l * int64 -> _ @>
                exactly <@ max : V3l -> V3l -> _ @>
            ]

            CIntrinsic.tagged "i64vec4(max({0}, {1}))", [
                exactly <@ Fun.Max : V4l * V4l   -> _ @>
                exactly <@ Fun.Max : V4l * int64 -> _ @>
                exactly <@ max : V4l -> V4l -> _ @>
            ]

            CIntrinsic.custom "max" [1; 0], [
                exactly <@ Fun.Max : int32   * V2i  -> _ @>
                exactly <@ Fun.Max : int32   * V3i  -> _ @>
                exactly <@ Fun.Max : int32   * V4i  -> _ @>
                exactly <@ Fun.Max : uint32  * V2ui -> _ @>
                exactly <@ Fun.Max : uint32  * V3ui -> _ @>
                exactly <@ Fun.Max : uint32  * V4ui -> _ @>
                exactly <@ Fun.Max : float32 * V2f  -> _ @>
                exactly <@ Fun.Max : float32 * V3f  -> _ @>
                exactly <@ Fun.Max : float32 * V4f  -> _ @>
            ...
            CIntrinsic.tagged "i64vec2(max({1}, {0}))", [
                exactly <@ Fun.Max : int64 * V2l -> _ @>
                exactly <@ max : int64 -> V2l -> _ @>
            ]

            CIntrinsic.tagged "i64vec3(max({1}, {0}))", [
                exactly <@ Fun.Max : int64 * V3l -> _ @>
                exactly <@ max : int64 -> V3l -> _ @>
            ]

            CIntrinsic.tagged "i64vec4(max({1}, {0}))", [
                exactly <@ Fun.Max : int64 * V4l -> _ @>
                exactly <@ max : int64 -> V4l -> _ @>
            ]
            ...
            CIntrinsic.tagged "int8_t(clamp({2}, {0}, {1}))", [
                exactly <@ clamp : int8 -> int8 -> int8 -> _ @>
            ]

            CIntrinsic.tagged "uint8_t(clamp({2}, {0}, {1}))", [
                exactly <@ clamp : uint8 -> uint8 -> uint8 -> _ @>
            ]

            CIntrinsic.tagged "int16_t(clamp({2}, {0}, {1}))", [
                exactly <@ clamp : int16 -> int16 -> int16 -> _ @>
            ]

            CIntrinsic.tagged "uint16_t(clamp({2}, {0}, {1}))", [
                exactly <@ clamp : uint16 -> uint16 -> uint16 -> _ @>
            ]

            CIntrinsic.tagged "int64_t(clamp({2}, {0}, {1}))", [
                exactly <@ clamp : int64 -> int64 -> int64 -> _ @>
            ]

            CIntrinsic.tagged "uint64_t(clamp({2}, {0}, {1}))", [
            ...
            CIntrinsic.tagged "clamp({2}, dvec2({0}), {1})", [
                exactly <@ clamp : float -> V2d -> V2d -> _ @>
            ]
            CIntrinsic.tagged "clamp({2}, dvec3({0}), {1})", [
                exactly <@ clamp : float -> V3d -> V3d -> _ @>
            ]
            CIntrinsic.tagged "clamp({2}, dvec4({0}), {1})", [
                exactly <@ clamp : float -> V4d -> V4d -> _ @>
            ]

            CIntrinsic.tagged "clamp({2}, {0}, dvec2({1}))", [
                exactly <@ clamp : V2d -> float -> V2d -> _ @>
            ]
            CIntrinsic.tagged "clamp({2}, {0}, dvec3({1}))", [
                exactly <@ clamp : V3d -> float -> V3d -> _ @>
            ]
            CIntrinsic.tagged "clamp({2}, {0}, dvec4({1}))", [
                exactly <@ clamp : V4d -> float -> V4d -> _ @>
            ]

            CIntrinsic.tagged "clamp({2}, ivec2({0}), {1})", [
                exactly <@ clamp : int32 -> V2i -> V2i -> _ @>
            ]
            CIntrinsic.tagged "clamp({2}, ivec3({0}), {1})", [
                exactly <@ clamp : int32 -> V3i -> V3i -> _ @>
            ]
            CIntrinsic.tagged "clamp({2}, ivec4({0}), {1})", [
                exactly <@ clamp : int32 -> V4i -> V4i -> _ @>
            ]

            CIntrinsic.tagged "clamp({2}, {0}, ivec2({1}))", [
                exactly <@ clamp : V2i -> int32 -> V2i -> _ @>
            ]
            CIntrinsic.tagged "clamp({2}, {0}, ivec3({1}))", [
                exactly <@ clamp : V3i -> int32 -> V3i -> _ @>
            ]
            CIntrinsic.tagged "clamp({2}, {0}, ivec4({1}))", [
                exactly <@ clamp : V4i -> int32 -> V4i -> _ @>
            ]

            CIntrinsic.tagged "i64vec2(clamp({2}, {0}, {1}))", [
                exactly <@ clamp : V2l   -> V2l   -> V2l -> _ @>
                exactly <@ clamp : int64 -> int64 -> V2l -> _ @>
            ]
            CIntrinsic.tagged "i64vec3(clamp({2}, {0}, {1}))", [
                exactly <@ clamp : V3l   -> V3l   -> V3l -> _ @>
                exactly <@ clamp : int64 -> int64 -> V3l -> _ @>
            ]
            CIntrinsic.tagged "i64vec4(clamp({2}, {0}, {1}))", [
                exactly <@ clamp : V4l   -> V4l   -> V4l -> _ @>
                exactly <@ clamp : int64 -> int64 -> V4l -> _ @>
            ]

            CIntrinsic.tagged "i64vec2(clamp({2}, i64vec2({0}), {1}))", [
                exactly <@ clamp : int64 -> V2l -> V2l -> _ @>
            ]
            CIntrinsic.tagged "i64vec3(clamp({2}, i64vec3({0}), {1}))", [
                exactly <@ clamp : int64 -> V3l -> V3l -> _ @>
            ]
            CIntrinsic.tagged "i64vec4(clamp({2}, i64vec4({0}), {1}))", [
                exactly <@ clamp : int64 -> V4l -> V4l -> _ @>
            ]

            CIntrinsic.tagged "i64vec2(clamp({2}, {0}, i64vec2({1})))", [
                exactly <@ clamp : V2l -> int64 -> V2l -> _ @>
            ]
            CIntrinsic.tagged "i64vec3(clamp({2}, {0}, i64vec3({1})))", [
                exactly <@ clamp : V3l -> int64 -> V3l -> _ @>
            ]
            CIntrinsic.tagged "i64vec4(clamp({2}, {0}, i64vec4({1})))", [
            ...
            CIntrinsic.tagged "clamp({0}, 0, 1)", [
                ...
                exactly <@ Fun.Saturate : V2ui -> _ @>
                exactly <@ Fun.Saturate : V3ui -> _ @>
                exactly <@ Fun.Saturate : V4ui -> _ @>
            ...
            CIntrinsic.tagged "int8_t(clamp({0}, 0, 1))", [
                exactly <@ Fun.Saturate : int8 -> _ @>
                exactly <@ saturate     : int8 -> _ @>
            ]

            CIntrinsic.tagged "uint8_t(clamp({0}, 0, 1))", [
                exactly <@ Fun.Saturate : uint8 -> _ @>
                exactly <@ saturate     : uint8 -> _ @>
            ]

            CIntrinsic.tagged "int16_t(clamp({0}, 0, 1))", [
                exactly <@ Fun.Saturate : int16 -> _ @>
                exactly <@ saturate     : int16 -> _ @>
            ]

            CIntrinsic.tagged "uint16_t(clamp({0}, 0, 1))", [
                exactly <@ Fun.Saturate : uint16 -> _ @>
                exactly <@ saturate     : uint16 -> _ @>
            ]

            CIntrinsic.tagged "int64_t(clamp({0}, 0, 1))", [
                exactly <@ Fun.Saturate : int64 -> _ @>
                exactly <@ saturate     : int64 -> _ @>
            ]

            CIntrinsic.tagged "uint64_t(clamp({0}, 0, 1))", [
                exactly <@ Fun.Saturate : uint64 -> _ @>
                exactly <@ saturate     : uint64 -> _ @>
            ]

            CIntrinsic.tagged "i64vec2(clamp({0}, 0, 1))", [
                exactly <@ Fun.Saturate : V2l -> _ @>
                exactly <@ saturate     : V2l -> _ @>
            ]

            CIntrinsic.tagged "i64vec3(clamp({0}, 0, 1))", [
                exactly <@ Fun.Saturate : V3l -> _ @>
                exactly <@ saturate     : V3l -> _ @>
            ]

            CIntrinsic.tagged "i64vec4(clamp({0}, 0, 1))", [
                exactly <@ Fun.Saturate : V4l -> _ @>
                exactly <@ saturate     : V4l -> _ @>
            ]
            ...
            CIntrinsic.tagged "normalize(dvec2({0}))", [
                exactly <@ Vec.Normalized : V2i  -> _ @>
                exactly <@ Vec.Normalized : V2ui -> _ @>
                exactly <@ Vec.Normalized : V2l  -> _ @>
                exactly <@ Vec.normalize  : V2i  -> _ @>
                exactly <@ Vec.normalize  : V2ui -> _ @>
                exactly <@ Vec.normalize  : V2l  -> _ @>
                exactly <@ fun (v : V2i)  -> v.Normalized @>
                exactly <@ fun (v : V2ui) -> v.Normalized @>
                exactly <@ fun (v : V2l)  -> v.Normalized @>
            ]

            CIntrinsic.tagged "normalize(dvec3({0}))", [
                exactly <@ Vec.Normalized : V3i  -> _ @>
                exactly <@ Vec.Normalized : V3ui -> _ @>
                exactly <@ Vec.Normalized : V3l  -> _ @>
                exactly <@ Vec.normalize  : V3i  -> _ @>
                exactly <@ Vec.normalize  : V3ui -> _ @>
                exactly <@ Vec.normalize  : V3l  -> _ @>
                exactly <@ fun (v : V3i)  -> v.Normalized @>
                exactly <@ fun (v : V3ui) -> v.Normalized @>
                exactly <@ fun (v : V3l)  -> v.Normalized @>
            ]

            CIntrinsic.tagged "normalize(dvec4({0}))", [
                exactly <@ Vec.Normalized : V4i  -> _ @>
                exactly <@ Vec.Normalized : V4ui -> _ @>
                exactly <@ Vec.Normalized : V4l  -> _ @>
                exactly <@ Vec.normalize  : V4i  -> _ @>
                exactly <@ Vec.normalize  : V4ui -> _ @>
                exactly <@ Vec.normalize  : V4l  -> _ @>
                exactly <@ fun (v : V4i)  -> v.Normalized @>
                exactly <@ fun (v : V4ui) -> v.Normalized @>
